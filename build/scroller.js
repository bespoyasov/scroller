  ...
  var Scroller = function () {
    ...
    _createClass(Scroller, [{
      ...
      value: function update(config) {
        ...
        var align = _config$align2 === undefined ? 'center' : _config$align2;
        var _config$noAnchors2 = config.noAnchors;
        var noAnchors = _config$noAnchors2 === undefined ? false : _config$noAnchors2;
        var _config$noScrollbar2 = config.noScrollbar;
        var noScrollbar = _config$noScrollbar2 === undefined ? false : _config$noScrollbar2;
        var onClick = config.onClick;
