...
//                                   //
//  Version: 3.0.3                   //
//  AuthorName: A. Bespoyasov        //
//  AuthorUrl: http://bespoyasov.ru  //
//                                   //
//  Using:                           // 
//       jQuery (v 1.8.3 and later)  //
//       jTweener                    //
//       mousewheel.js               //
//                                   //
/* ================================= */
      ...
      'borderLines' : true
		...
		return this.each(function(){
			...
			var 
				...
				var lftBrdr = 0, rgtBrdr = $el.parent().width() - $el.width(); 
				...
				anchors = []; anc_coords = []; screen_anc_coords = [];	
				...
				// only the God knows, how it works
				  var devDown = 'mousedown', devMove = 'mousemove', devUp = 'mouseup';
				    ...
				    else if (window.navigator.msPointerEnabled) {isTouch=true;
				...
				/* ======================== */ 	
					...
					$el.removeClass('grabbing');
						...
						if (isVeryWide($(event.target).closest('.'+scrNm)) && $(event.target).is('a')) {
